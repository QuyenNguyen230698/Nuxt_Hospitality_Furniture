<template>
  <div class="flex justify-between items-center gap-5" ref="dropdownContainer">
    ...
    padding-right: 0rem !important;"
        ...
        <NuxtImg quality="75" loading="eager" alt="language" aria-label="language" class="w-8 h-8 aspect-square rounded-full shadow-xl"
      ...
      <ul class="menu dropdown-content bg-base-100 rounded z-40 w-40 mr-3 p-1 shadow">
        <li><button @click="selectLanguage('en-US')" class="custorm-btn w-full">
            <NuxtImg quality="75" loading="eager" alt="english" aria-label="english" class="w-8 h-8 rounded-full" src="image/header/language-en.png" />
