    ...
    <div class="p-2 w-full h-full bg-image-member">
            <div class="w-full">
              <div class="grid grid-cols-2 md:grid-cols-4 w-full text-center gap-4">
                ...
                <div class="flex flex-col items-center justify-center color-section lg:py-5">
                  <svg class="h-10 hover:scale-110 duration-300 cursor-pointer icon-section fill-current" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 250 250" xml:space="preserve">
