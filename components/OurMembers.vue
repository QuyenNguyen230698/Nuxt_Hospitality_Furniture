<template>
    <div class="bg-image-member w-full h-full pb-5 px-14 relative">
        ...
        <div class="container mx-auto text-center flex flex-col w-full h-full text-white py-6">
            <h2 class="text-center text-3xl lg:text-5xl font-bold p-6 text-white leading-normal z-10">{{ $t('app.members.ourmembers') }}</h2>
