        ...
        <div class="absolute inset-0 h-full bg-slice-2 pointer-events-none z-30"></div>
            ...
            <div class="flex flex-col w-full h-full justify-center items-center relative z-40">
              <div class="flex flex-col justify-center items-center text-white container m-2 md:m-4 lg:m-8 mx-auto">
                <h2 class=" font-black text-center leading-snug tracking-widest uppercase md:pb-2 lg:pb-4" >
                  <span class="text-xl lg:text-5xl">{{ $t('app.sliceShow.tophospitality') }}</span>
                  <br>
                  <span class="text-xl lg:text-5xl">{{ $t('app.sliceShow.inVietnam') }}</span>
                </h2>
              ...
              <div class="flex flex-col md:flex-row justify-center items-center gap-2 md:gap-4 w-full">
                ...
                <button class="transition-colors duration-300 border-2 w-2/5 md:w-2/6 lg:w-1/5 h-10 lg:h-12 text-sm md:text-md leading-none btn-hover2 rounded-md uppercase"><a href="/capabilityprofile">{{ $t('app.sliceShow.capabilityprofile') }}</a></button>
              </div>
            </div>
            <!-- video show -->
            <div>
