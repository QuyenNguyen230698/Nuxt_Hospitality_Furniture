    ...
    <div class="bg-black color-text">
        ...
        <div class="bg-ritz p-4 lg:p-0 lg:py-16">
            <div class="flex flex-col lg:flex-row items-center justify-center gap-5 bg-solution w-full h-full">
                ...
                <!-- Content -->
                <div class="flex flex-col items-center justify-center w-full md:w-1/2 h-full p-20 container mx-auto bg-content">
                    <div><h2 class="text-center text-3xl lg:text-5xl font-bold p-6 text-white">{{ $t('app.ritz.ritzcarlton') }}</h2></div>
                        ...
                        <div class="flex flex-col w-full h-full gap-1 mb-4 lg:mb-0 md:gap-4 py-2 md:py-8">
                            ...
                            <div class="flex flex-row w-full h-full">
                                <p>
                                    ...
                                    <span class="text-gray-300 font-thin lg:text-lg">{{ $t('app.ritz.locationDesc') }}</span>
                                </p>
                            </div>
                        </div>
...
const solution = [
  { src: "/image/RitzCarlton/ritz1.jpg" },
  { src: "/image/RitzCarlton/ritz2.jpg" },
  { src: "/image/RitzCarlton/ritz3.jpg" },
  { src: "/image/RitzCarlton/ritz4.jpg" },
  { src: "/image/RitzCarlton/ritz5.jpg" },
];
