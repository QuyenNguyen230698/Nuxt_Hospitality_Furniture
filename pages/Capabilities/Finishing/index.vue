    ...
    <div>
        ...
        <div class="flex flex-col lg:flex-row items-center justify-center gap-5 w-full h-full">
          ...
          <h2 class="text-center text-3xl lg:text-5xl font-bold p-6 text-white">
            {{ $t('app.finishing.engineeredVeneers') }}
          </h2>
          ...
          <p class="text-base color-text text-justify mb-5 leading-loose">
            {{ $t('app.finishing.finishingDescription') }}
          </p>
        </div>
      </div>
      </div>
...
const pvd = [
  { src: "/image/capability/Finishing/engineer1.jpg" },
  { src: "/image/capability/Finishing/engineer2.jpg" },
  { src: "/image/capability/Finishing/engineer3.jpg" },
  { src: "/image/capability/Finishing/engineer4.jpg" },
  { src: "/image/capability/Finishing/engineer5.jpg" },
  { src: "/image/capability/Finishing/engineer6.jpg" },
];
...
useSeoMeta({
    title: 'Finishing - Hospitality Furniture',
    ogTitle: 'Finishing - Hospitality Furniture',
    ...
    ogUrl: 'https://nuxt-hospitality-furniture.vercel.app/capabilities/finishing',
    ogType: 'event',
    ogSiteName: 'Finishing - Hospitality Furniture',
    ogLocale: 'en_US',
    twitterCard: 'summary_large_image',
    twitterTitle: 'Finishing - Hospitality Furniture',
    ...
    keywords: 'Finishing, Hospitality Furniture',
})
</script>
